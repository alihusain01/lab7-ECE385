...
module lab7_soc_mm_interconnect_0 (
	...
	wire  [107:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> buttons_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                              // buttons_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [16:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> buttons_s1_agent:cp_channel
	...
	wire  [107:0] buttons_s1_agent_rp_data;                                                           // buttons_s1_agent:rp_data -> router_009:sink_data
	...
	wire   [16:0] cmd_demux_src6_channel;                                                             // cmd_demux:src6_channel -> crosser_001:in_channel
	...
	wire  [107:0] cmd_demux_001_src5_data;                                                            // cmd_demux_001:src5_data -> crosser_002:in_data
	wire          cmd_demux_001_src5_ready;                                                           // crosser_002:in_ready -> cmd_demux_001:src5_ready
	wire   [16:0] cmd_demux_001_src5_channel;                                                         // cmd_demux_001:src5_channel -> crosser_002:in_channel
	...
	wire  [107:0] crosser_002_out_data;                                                               // crosser_002:out_data -> cmd_mux_006:sink1_data
	wire          crosser_002_out_ready;                                                              // cmd_mux_006:sink1_ready -> crosser_002:out_ready
	wire   [16:0] crosser_002_out_channel;                                                            // crosser_002:out_channel -> cmd_mux_006:sink1_channel
	...
	wire   [16:0] rsp_demux_001_src0_channel;                                                         // rsp_demux_001:src0_channel -> crosser_003:in_channel
	...
	wire   [16:0] crosser_003_out_channel;                                                            // crosser_003:out_channel -> rsp_mux:sink1_channel
	...
	wire  [107:0] rsp_demux_006_src0_data;                                                            // rsp_demux_006:src0_data -> crosser_004:in_data
	wire          rsp_demux_006_src0_ready;                                                           // crosser_004:in_ready -> rsp_demux_006:src0_ready
	wire   [16:0] rsp_demux_006_src0_channel;                                                         // rsp_demux_006:src0_channel -> crosser_004:in_channel
	...
	wire  [107:0] crosser_004_out_data;                                                               // crosser_004:out_data -> rsp_mux:sink6_data
	wire          crosser_004_out_ready;                                                              // rsp_mux:sink6_ready -> crosser_004:out_ready
	wire   [16:0] crosser_004_out_channel;                                                            // crosser_004:out_channel -> rsp_mux:sink6_channel
	...
	wire  [107:0] rsp_demux_006_src1_data;                                                            // rsp_demux_006:src1_data -> crosser_005:in_data
	wire          rsp_demux_006_src1_ready;                                                           // crosser_005:in_ready -> rsp_demux_006:src1_ready
	wire   [16:0] rsp_demux_006_src1_channel;                                                         // rsp_demux_006:src1_channel -> crosser_005:in_channel
	...
	wire  [107:0] crosser_005_out_data;                                                               // crosser_005:out_data -> rsp_mux_001:sink5_data
	wire          crosser_005_out_ready;                                                              // rsp_mux_001:sink5_ready -> crosser_005:out_ready
	wire   [16:0] crosser_005_out_channel;                                                            // crosser_005:out_channel -> rsp_mux_001:sink5_channel
	...
	lab7_soc_mm_interconnect_0_router_002 router_018 (
	...
	lab7_soc_mm_interconnect_0_cmd_mux cmd_mux_016 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_rsp_demux rsp_demux_016 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
